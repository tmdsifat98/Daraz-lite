...
const Banner = () => {
  ...
  return (
    <div>
      ...
      <p className="text-center mx-auto mt-4 text-gray-500 w-1/3">
        Best place to browse, search, view details and purchase of top flagship
        phones of the current time - FlagshipFaceOff
      </p>

      <form className="flex justify-center gap-1 items-center my-4">
        <input
          value={searchText}
          onChange={(e) => setSearchText(e.target.value)}
          placeholder="Search phone by name or brand name"
          className="w-1/3 border focus:outline-none text-lg px-5 text-gray-600 border-gray-200 py-3 rounded"
          type="text"
        />
