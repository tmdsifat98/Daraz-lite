...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center py-4 px-6 relative border-b-1">
      ...
      <ul className={`${open?"-top-36":"top-16"}  lg:hidden absolute right-1 gap-2 rounded z-10  bg-slate-100 flex flex-col px-6 py-4 justify-center items-center transition-all duration-700`}>
        {links}
      </ul>
    </div>
  );
